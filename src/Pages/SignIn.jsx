    ...
    <section>
        ...
        <div className='flex justify-center flex-wrap items-center max-w-6xl px-6 py-12 mx-auto'>
            ...
            <form action="">
                    ...
                    <button className='w-full bg-blue-600 text-white px-7 py-3 rounded text-sm fount-medium uppercase shadow-md hover:bg-blue-700 transition duration-150 ease-in-out'>Sign in</button>
